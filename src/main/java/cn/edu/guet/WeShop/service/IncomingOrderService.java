...
public interface IncomingOrderService {
    ...
    //第一种情况是：商品表已存在进货的商品
    void newIncomingOrderCaseOne(IncomingOrderdetail incomingOrderDetail, IncomingOrderbase incomingOrderbase, Item_stock item_stocks);

    //第二种情况是：商品表还没有进货的商品
    void newIncomingOrderCaseTwo(IncomingOrderdetail incomingOrderDetail, IncomingOrderbase incomingOrderbase, Item_stock item_stocks, Item items);
}
