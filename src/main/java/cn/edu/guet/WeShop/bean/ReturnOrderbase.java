...
public class ReturnOrderbase {
    private String id;
    private String user_id;
    private double money;
    private Timestamp time;

    public ReturnOrderbase(){

    }

    public ReturnOrderbase(String id, String user_id, double money, Timestamp time) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        ReturnOrderbase that = (ReturnOrderbase) o;
